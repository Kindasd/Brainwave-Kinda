...
import { brainwaveServices, brainwaveServicesIcons } from "../constans/index.js";
      ...
      <div className="container">
        ...
        <div className="relative">
          <div className="relative z-10 flex items-center h-[39rem] mb-5 p-8 border border-n-1/10 rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]">
            ...
            <div className="absolute left-4 right-4 bottom-4 border-n-1/10 border lg:left-1/2 lg:right-auto lg:bottom-8 lg:-translate-x-1/2 rounded-3xl">
              <Generating />
            </div>
          </div>
        </div>
          ...
          <div className="p-4 bg-n-7 rounded-3xl overflow-hidden lg:min-h-[46rem] ">
            <div className="py-12 px-4 xl:px-8 ">
              ...
              <p className="body-2 mb-[2rem] text-n-3 ">
                The worldis most powerful AI photo and video art generation engine.What will you create?
              </p>
              <ul className=" rounded-2xl flex items-center justify-between ">
                {brainwaveServicesIcons.map((item, index) => (
                  <li 
                  key={index}
                  className={`flex items-center justify-center ${index === 2 ? 'w-[3rem] h-[3rem] p-0.3 bg-conic-gradient rounded-2xl md:w-[4.5rem] md:h-[4.5rem]' : 'flex w-10 h-10 bg-n-6'} md:w-15 md:h-15 `}>
