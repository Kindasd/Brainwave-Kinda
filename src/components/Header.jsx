...
import { navigation } from "../constans/index.js";
        ...
        <div className={'fixed top-0 left-0 w-full z-50 bg-n-8/90 backdrop-blur-sm border-b border-n-6 lg:bg-n-8/90 lg:backdrop-blur-sm ${openNavigation "bg-n-8 ": "bg-n-8/90 backdrop:blur-sm"}'}>
            <div className="flex items-center px-5 lg:px-7.5 xl:px-10 max-lg:py-4">
                ...
                <nav className={` ${openNavigation ? "flex" : "hidden"}  fixed top-[5rem] left-0 right-0 bottom-0 bg-n-8 lg:static lg:flex lg:mx-auto lg:bg-transparent`}> 
                    <div className="relative z-2 flex flex-col bg-black  items-center justify-center m-auto lg:flex-row">
                    {navigation.map((item) => (
                            <a 
                                key={item.id} 
                                href={item.url}
                ...
                <Button className="hidden lg:flex top-0 py-5 " href="#login">
                   Sign in
                </Button>
